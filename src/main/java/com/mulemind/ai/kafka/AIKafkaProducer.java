...
public class AIKafkaProducer {
    ...
    private static final Logger log = LoggerFactory.getLogger(AIKafkaProducer.class);

    private final KafkaTemplate<String, Object> kafkaTemplate;

    @Value("${app.kafka.topic.mulemind-metadata-generated-event}")
    private String metaGeneratedTopic;

    public AIKafkaProducer(KafkaTemplate<String, Object> kafkaTemplate) {
    ...
    public void send(Object event, String key) {
        ...
        Message<Object> message = MessageBuilder
                .withPayload(event)
                .setHeader(KafkaHeaders.TOPIC, metaGeneratedTopic)
